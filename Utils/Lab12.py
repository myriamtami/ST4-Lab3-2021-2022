...
#Convertir une requête sous la forme d'une chaîne de caractères en une requête sous la forme d'une liste de termes filtres et normalises
...
#Recuperer la fréquence d'un terme dans un document à partir d'un index de fréquence
